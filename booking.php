...
<section class="booking-area pt-80 pb-80">
    <div class="container">
        <div class="section-title">
            <span>book a <span>court</span></span>
        </div>
        <div class="section-caption">
            <p>Hassle-free court bookings and state-of-the-art facilities.</p>
        </div>
        <div class="booking-form">
            <h4>booking from</h4>
            <form action="indooListSearch.php" method="post">
                <div class="form-group">
                    <div class="booking-form-details">
                       
                      <div class="search-container">
                        <input type="search" id="search" name="search" placeholder=" Search Location"  required> 
                      </div>
                    </div>
                </div>
            </form>
